    ...
    const day: any = {
      ...
      meals: [
        ...
        },
        {
          ...
          slot: "lunch",
          status: "planned",
          calories_planned: 700.4,
          portion_multiplier: 1,
          portions_to_cook: 2,
          multi_portion_group_id: null,
          is_leftover: false,
          recipe: { id: 2, name: "B", image_url: null, time_minutes: 0, source_url: "", available_slots: ["lunch"] },
        },
      ],
    };
